...
\begin{table}[h]
\centering
\caption{Condition-B apparent false positives by dominant relation. Some MR-F1 flags may reflect latent semantic errors not exposed by the two held-out seeds.}
\small
